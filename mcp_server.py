...
def edit_document(
    ...
    new_str: str = Field(description="The new contents of the document.")
):
    if doc_id not in docs:
        raise ValueError(f"Doc with ID `{doc_id}` not found.")
...
def summarize_document(
    ...
    Summarize the key points of the document in a concise manner. Use bullet points if necessary.
    """
